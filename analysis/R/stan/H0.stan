...
model{
  ...
  target += normal_lpdf(mu_P | mu0, sig_mu);
  target += normal_lpdf(mu_I | mu0, sig_mu);
  target += normal_lpdf(kappa_W | kappa0, sig_kappa);
  target += normal_lpdf(kappa_P | kappa0, sig_kappa);
  target += normal_lpdf(kappa_I | kappa0, sig_kappa);
